...
public class Main {
   ...
   public static void main(String[] args) throws InterruptedException {
      ...
      Vector<Car> carList = new Vector<Car> (Ncars);                                // create a queue/list of cars
      Vector<Passenger> passList = new Vector<Passenger> (Npass);                   // create a queue/line of passengers
