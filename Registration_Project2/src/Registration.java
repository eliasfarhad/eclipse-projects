	...
	public static void main(String[] args) {
		...
		//	PrintWriter p = new PrintWriter(new FileWriter(file2));
			...
			while (answer != 9) {
				...
				TreeOperation tOperation = new TreeOperation();
				...
				if (answer == 1) {
					...
					tMap.put(s1.getLastName(), s1);
					tOperation.printAll(tMap,"The student has been added. Here's the updated registration database");
					

					//System.out.println("The student has been added. Here's the updated registration database");

					//obj.print(sArray,p, "The student has been added. Here's the updated registration database");
				...
				// deleting a student from the database
					...
					tMap.remove(str);
					tOperation.printAll(tMap,"The student has been deleted. Here's the updated registration database");
					
					//System.out.println("The student has been deleted. Here's the updated registration database");

					//obj.print(sArray,p, "The student has been deleted. Here's the updated registration database");
					ouputPageNumber++;
					//System.out.println();
					p.close();
				}
					...
					if (index == -1)
						...
						p.println("Here's that student's info:");
						...
						for (int j = 0; j < sArray[index].courseList.size(); j++) {
							...
							p.println(sArray[index].courseList.get(j).getCourseNumber() + "	 "
									+ sArray[index].courseList.get(j).getGradeRecieved());
						}

					}
					*/
					tOperation.printSpecific(tMap, str);
					...
					*/
					//obj.print(sArray,p, " Here's the registration database");
					
					tOperation.printAll(tMap, " Here's the registration database");
					p.close();
					...
					*/
					...
					//else {
						...
						*/
						...
						for ( int j =0; j<tempStudent.courseList.size(); j++){
							...
							tempGpa += (tempStudent.courseList.get(j).getGradePoint() * tempStudent.courseList.get(j).getNumberOfCredits());
						}
						...
						//obj.print(sArray,p, "The course has been added. Here's the updated registration database");
						ouputPageNumber++;
						System.out.println();
						p.close();
					//}
					...
					if (position == -1) {
						...
						obj.print(sArray,p,"The course has been deleted. Here's the updated registration database" );
						ouputPageNumber++;
						System.out.println();
						p.close();
					}
