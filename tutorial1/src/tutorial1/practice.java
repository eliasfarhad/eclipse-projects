...
public class practice {
   ...
   static String inFileName = "practice.txt";
   ...
   public static void inputFromFile(String fileName, String[] array){
       ...
       for ( int i = 0; i < lengthFilled - 1; i++ ) { 
          ...
          if (array[indexLowest] != array[i]/*(array[j].compareTo(array[indexLowest])) < */ ) { 
